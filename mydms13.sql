...
SELECT SYSDATE FROM DEPOSIT;
SELECT SYSDATE;
SELECT ADD_MONTHS(ADATE,4) FROM DEPOSIT;
--THIS ADD 4 MONTHS TO EVERY DATE ENTRIES
SELECT ADD_MONTHS(ADATE,4) FROM DEPOSIT WHERE AMOUNT=1200;
SELECT TRUNC(ADATE,'MM')FROM DEPOSIT; 
SELECT TRUNC(ADATE,'YY')FROM DEPOSIT;
