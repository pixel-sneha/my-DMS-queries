...
SELECT CNAME FROM DEPOSIT UNION SELECT CITY FROM BRANCH;
SELECT BNAME FROM DEPOSIT UNION ALL SELECT CITY FROM BRANCH;
SELECT BNAME FROM DEPOSIT INTERSECT SELECT BNAME FROM BRANCH;
SELECT BNAME FROM DEPOSIT MINUS SELECT BNAME FROM BRANCH;
