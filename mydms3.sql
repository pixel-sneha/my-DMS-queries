--USING EQUAL T0,IN,NOT IN,BETWEEN AND OTHER VALUE MATCHING CONDITIONS
...
SELECT * FROM DEPOSIT WHERE ACTNO = '107';
SELECT * FROM DEPOSIT WHERE AMOUNT = 5000;
SELECT * FROM DEPOSIT WHERE AMOUNT IN(1000,5000);
SELECT * FROM DEPOSIT WHERE AMOUNT NOT IN(1000,5000,3000,7000);
...
SELECT * FROM BORROW WHERE LOANNO BETWEEN '300' AND '350';
SELECT * FROM BORROW WHERE AMOUNT>5000;
SELECT * FROM BORROW WHERE LOANNO<='321';
